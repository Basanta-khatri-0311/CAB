  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-black">
        ...
        <p className="mt-4 text-xs font-bold tracking-widest text-gray-300 uppercase">Assembling Directory</p>
      </div>
    );
  }
    ...
    <div className="bg-black min-h-screen text-gray-200 pb-20">
      <div className="max-w-7xl mx-auto px-6 pt-32 text-center">
        <header className="mb-24">
          ...
          <p className="text-gray-300 max-w-xl mx-auto text-sm leading-relaxed font-medium">
        ...
        {committee.length > 0 && (
          <div className="mb-40">
            <div className="text-left mb-16 border-l-4 border-brand pl-8">
               ...
               <p className="text-gray-300 text-sm mt-2 font-medium">Board members and strategic leadership of the association.</p>
            </div>
        ...
        {squad.length > 0 && (
          <div className="mb-40">
            <div className="text-left mb-16 border-l-4 border-purple-500 pl-8">
               ...
               <p className="text-gray-300 text-sm mt-2 font-medium">Our cricketers bringing prestige to Bhaluhi on the field.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        {others.length > 0 && (
          <div>
            <div className="text-left mb-16 border-l-4 border-zinc-800 pl-8">
               ...
               <p className="text-gray-300 text-sm mt-2">The backbone of our association operations.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {others.map((member) => (
                <div key={member._id} className="bg-zinc-900/30 border border-white/5 rounded-[2.5rem] p-6 md:p-8 text-center hover:border-brand/40 transition-all shadow-xl group">
                   ...
                   <p className="text-gray-400 text-[10px] mt-2 font-medium">Active Member</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {members.length === 0 && (
          <div className="py-40 text-center">
             <p className="text-gray-400 font-black tracking-[0.2em] uppercase text-xs animate-pulse underline decoration-brand underline-offset-8">No members found in directory</p>
          </div>
        )}
      </div>
    </div>
    ...
    <div className="group bg-zinc-900/40 border border-white/5 rounded-[3rem] md:rounded-[4rem] p-6 md:p-12 flex flex-col items-center relative overflow-hidden transition-all duration-700 hover:border-brand/40 hover:-translate-y-3 shadow-2xl">
      ...
      <div className="relative mb-10">
        <div className="w-40 h-40 rounded-full bg-black border-4 border-brand/10 group-hover:border-brand/60 transition-all duration-700 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden">
          {member.photo ? (
            <img loading="lazy" src={optimizeCloudinaryUrl(member.photo)} alt={member.name} className="w-full h-full object-cover  transition-all duration-700 transform group-hover:scale-110" />
          ) : (
      ...
      <div className="text-center flex-grow">
        ...
        <p className="text-gray-300 text-sm font-medium leading-relaxed line-clamp-3 px-4">
      ...
      <div className="mt-12 pt-10 border-t border-white/5 w-full flex justify-between items-center px-6">
        <div className="text-left">
          <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1">Joined Association</p>
