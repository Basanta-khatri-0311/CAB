...
const allRoles = [
  { group: "Leadership", options: ["President", "Vice President", "Treasurer", "Secretary", "Advisor"] },
  { group: "Squad", options: ["Captain", "Vice Captain", "Wicket Keeper", "Player", "Senior Player"] },
                  ...
                  <div className="grid grid-cols-2 gap-3">
                     {group.options.map(role => (
                        <button
                         ...
                         className={`px-4 py-4 rounded-xl border text-[9px] font-black uppercase tracking-widest transition-all ${
                           form.roleInClub.includes(role)
